...
public class C01_JUnitFirstTest {
    ...
    // hangi tool u kullaniyorsa ona framework kurar testlerinizi orda kosturursunuz. Framework bir çalışma prensibidir. Framework neyin nerede olacaginin belli olmasidir.
    ...
    // @Test notasyonu eklemedigimiz method test sırasında çalışıtırılmaz. Ancak cagrilirsa calisir. Before notasyonu, her test method’undan önce çalışır. After notasyonu, her test method’undan
