...
public class C01_ExcelRead {
    ...
    public void readExcelTest() throws IOException {
        ...
        // Sayfayi/Sheet1 ac
        Sheet sheet1 = workbook.getSheet("Sheet1"); // Sheet sheet1 = workbook.getSheetAt(0); ==> index sayisinin degisme olasiligi oldugu icin tavsiye edilmez.
        ...
        int sumRowNumber = sheet1.getLastRowNum()+1; // index 0 dan basladıgı icin 1 ekliyoruz
        System.out.println(sumRowNumber); // 11

        // Fiziki olarak kullanilan toplam satir sayisini bul
        int sumRowUsedNumber = sheet1.getPhysicalNumberOfRows();
        ...
        for (int i = 1; i<sheet1.getLastRowNum()+1; i++){ // sheet1.getPhysicalNumberOfRows()
        ...
        for (int i = 0; i<sheet1.getLastRowNum()+1; i++){
            for (int j = 0; j<sheet1.getRow(i).getPhysicalNumberOfCells(); j++){ // sheet1.getRow(i).getLastCellNum()+1
