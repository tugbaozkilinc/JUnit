...
public class C02_Log4J {
    ...
    //Nasil eklenir?
    //Proje seviyesinde resources package i olustur, icinde log4j2.xml(.xml uzantili olmak zorunda) adinda file olustur, verilen kodlari yapistir. Onemli bir dosya oldugunu belirtmek icin;
