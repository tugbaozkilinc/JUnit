...
public class C03_FileExist {
    ...
    public void isExistTest() {
        ...
        String userDIR = System.getProperty("user.dir"); //icinde bulunulan klasörün yolunu(Path) verir. (gives the path of the current folder)
        System.out.println(userDIR); //C:\Users\tugba\Desktop\JAVA\com.B103Maven_Junit
        String userHOME = System.getProperty("user.home"); //bilgisayarimizda bulunan user klasörünü verir. (gives you the user folder)
