...
public class Homework03 extends TestBase {
    ...
    public void test01() {
        ...
        WebElement searchBoxNew = driver.findElement(By.xpath("//*[@title='Search in']"));
        Select searchBoxDropdownNew = new Select(searchBoxNew);
        searchBoxDropdownNew.selectByVisibleText("Baby");

        // bebek puset aratıp bulundan sonuç sayısını yazdırın
        searchBoxNew.sendKeys(Keys.TAB, "bebek puset", Keys.ENTER);
